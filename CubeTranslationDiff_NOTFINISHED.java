...
public class CubeTranslationDiff_NOTFINISHED extends JPanel {

    private BufferedImage buffer;
    private int[] centerPoint = {400, 400, 0}; // Starting center point of the cube
    private int size = 10; // Size of the cube (increased for better visibility)
    private Color color = Color.RED; // Color of the cube

    public CubeTranslationDiff_NOTFINISHED() {
    ...
    public static void main(String[] args) {
        ...
        CubeTranslationDiff_NOTFINISHED panel = new CubeTranslationDiff_NOTFINISHED();
        frame.add(panel);
